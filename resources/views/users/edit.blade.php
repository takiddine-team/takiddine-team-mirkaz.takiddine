                ...
                <form action="{{ route('users.update',['id' => $user->id]) }}" method="post">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input type="text" class="form-control nexa-light" id="name" value ="{{$user->name}}" placeholder="أدخل إسم المستخدم" name="name">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            <label for="email">البريد الإلكتروني:</label>
                            <input type="text" class="form-control nexa-light" id="email" value ="{{$user->email}}"  placeholder="أدخل البريد الإلكتروني" name="email">
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                            <label for="password">كلمة المرور:</label>
                            <input type="password" class="form-control" id="password"  placeholder="أدخل  كلمة المرور" name="password" >
                            </div>
                        </div>
                    </div>
                    <div class="row">
                                    ...
                                    <div class="col-3 service">
                                        ...
                                        @foreach ($done_service['buttons'] as $permission)
                                            ...
                                            <div class="form-group form-check">
                                                <input type="checkbox" class="form-check-input pv_permission"  value="{{$permission['id']}}" name="permission[]" checked>
